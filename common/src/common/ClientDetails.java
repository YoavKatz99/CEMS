 ...
 *
 * The ClientDetails class stores information about the client, including the
 * server IP, client IP, and connection status.
 */
...
public class ClientDetails {
	...
	/**
	 * get the serverIP of the client to display it into the tableview of the
	 * server.
	 * 
	 * @return serverIP
	 */
	...
	/**
	 * get the clientIP of the client to display it into the tableview of the
	 * server.
	 * 
	 * @return clientIP
	 */
